...
| -------------------------------------------------- | --------------- | --------------- |
| single-threaded decode — bun (JSC)                 | 🟢 1.82× faster | 🟢 1.97× faster |
| single-threaded decode — Chrome (V8)               | 🟢 1.79× faster | 🟢 1.48× faster |
| `GLTFLoader.parse`, warm worker pool — Chrome (V8) | 🟢 1.74× faster | 🟢 1.03× faster |
| `GLTFLoader.parse`, cold first load — Chrome (V8)  | 🟢 1.60× faster | 🟢 1.38× faster |

## Download size

| download (brotli)             | minidraco | vs draco.js              | vs draco3d wasm          |
| ----------------------------- | --------- | ------------------------ | ------------------------ |
| single-threaded (default)     | 21 KB     | 🟢 1.04× smaller (22 KB) | 🟢 3.80× smaller (81 KB) |
